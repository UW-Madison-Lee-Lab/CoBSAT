        ...
        for mllm in mllms:
            ...
            for shot in shots:
                ...
                for theta in theta_list: # one function
                    ...
                    json_file = f"{folder}/detail/[{data_id}]{task_name}_{mllm}_{shot}shot_{theta}({(score_per_object/number_per_object):2f})({(strict_score_per_object/number_per_object):.2f}).json"
